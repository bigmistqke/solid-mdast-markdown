...
describe('MDRenderer', () => {
      ...
      it('renders strikethrough within paragraph', () => {
        ...
        expect(asFragment()).toRenderEqual("<p>This is <del>deleted</del> text.</p>")
      })
      ...
      it('renders inline link', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\">Example.comhttps://example.com</a></p>")
      })
      it('renders autolink', () => {
      ...
      it('renders nested blockquotes', () => {
        ...
        expect(asFragment()).toRenderEqual("<blockquote style=\"border-left:4px solid var(--cm-editor-selectionBackground, #ddd);padding-left:16px;margin:8px 0\"><span>This is a blockquote</span><blockquote style=\"border-left:4px solid var(--cm-editor-selectionBackground, #ddd);padding-left:16px;margin:8px 0\"><span>This is a nested blockquote</span><blockquote style=\"border-left:4px solid var(--cm-editor-selectionBackground, #ddd);padding-left:16px;margin:8px 0\"><span>And this is triple nested</span></blockquote></blockquote></blockquote>")
      })
      it('renders blockquotes with emphasis and links', () => {
        ...
        expect(asFragment()).toRenderEqual("<blockquote style=\"border-left:4px solid var(--cm-editor-selectionBackground, #ddd);padding-left:16px;margin:8px 0\"><span>This is a <strong>bold</strong> statement with <a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\">a linkhttps://example.com</a></span><span>And this is <em>italic</em> text in the same blockquote</span></blockquote>")
      })
      it('renders blockquotes with lists', () => {
        const { asFragment } = render(() => <MDRenderer content={"> This blockquote contains a list:\n> \n> 1. First item\n> 2. Second item\n> 3. Third item" } />)
        expect(asFragment()).toRenderEqual("<blockquote style=\"border-left:4px solid var(--cm-editor-selectionBackground, #ddd);padding-left:16px;margin:8px 0\"><span>This blockquote contains a list:</span><ol><li> <span>First item</span></li><li> <span>Second item</span></li><li> <span>Third item</span></li></ol></blockquote>")
      })
      ...
      it('renders strikethrough with nested emphasis', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><del>This is deleted with <strong>bold</strong> and <em>italic</em> text</del></p>")
      })
      it('renders complex nested emphasis combinations', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><em><strong>This is bold and italic</strong></em> with <del>strikethrough <strong>and bold</strong></del></p>")
      })
      it('renders links with emphasis', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\"><strong>Bold link</strong>https://example.com</a> and <a href=\"https://test.com\" target=\"_blank\" rel=\"noopener noreferrer\"><em>italic link</em>https://test.com</a></p>")
      })
      it('renders images within links', () => {
        const { asFragment } = render(() => <MDRenderer content={"[![Alt text](image.jpg)](https://example.com)" } />)
        expect(asFragment()).toRenderEqual("<p><a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\"><img src=\"image.jpg\" alt=\"Alt text\">https://example.com</a></p>")
      })
      it('renders links in lists', () => {
        ...
        expect(asFragment()).toRenderEqual("<ul><li> <span><a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\">Link 1https://example.com</a></span></li><li> <span>Visit <a href=\"https://google.com\" target=\"_blank\" rel=\"noopener noreferrer\">Googlehttps://google.com</a> for search</span></li><li> <span>Multiple <a href=\"https://a.com\" target=\"_blank\" rel=\"noopener noreferrer\">linkshttps://a.com</a> in <a href=\"https://b.com\" target=\"_blank\" rel=\"noopener noreferrer\">onehttps://b.com</a> item</span></li></ul>")
      })
      it('renders code within links', () => {
        const { asFragment } = render(() => <MDRenderer content={"[Check out `console.log()`](https://developer.mozilla.org)" } />)
        expect(asFragment()).toRenderEqual("<p><a href=\"https://developer.mozilla.org\" target=\"_blank\" rel=\"noopener noreferrer\">Check out <code style=\"background-color:var(--cm-editor-background, rgba(128, 128, 128, 0.1));padding:2px 4px;border-radius:3px;font-family:monospace\">console.log()</code>https://developer.mozilla.org</a></p>")
      })
      ...
      it('allows custom link renderer with additional attributes', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><a href=\"https://example.com\" target=\"_blank\" rel=\"noopener noreferrer\">Original Linkhttps://example.com</a></p>")
      })
