...
describe('MDRenderer', () => {
      ...
      it('renders code within links', () => {
        ...
        expect(asFragment()).toRenderEqual("<p><a href=\"https://developer.mozilla.org\" target=\"_blank\" rel=\"noopener noreferrer\">Check out </a></p>")
      })
